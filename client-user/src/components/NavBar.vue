    ...
    >
      ...
      <div class="hidden lg:block">
        <ul class="flex gap-3 text-md">
          ...
          <li>
            <router-link
              class="text-blue-500 block font-bold text-sm py-2 pl-3 pr-4 rounded md:bg-transparent md:text-gray-400 md:p-0 hover:text-blue-700 text-bold"
              v-if="!isLoggedIn"
              to="/login"
            >
              <span class="text-blue-800"> LOGIN </span>
            </router-link>
          </li>
          <li
